...
public class DrawingsView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public DrawingsView(Context c) {
        this(c, null);
    }

    public DrawingsView(Context c, AttributeSet attrs) {
        this(c, attrs, 0);
    }

    public DrawingsView(Context c, AttributeSet attrs, int defStyle) {
